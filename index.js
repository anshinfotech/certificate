...
server.post("/get-certificate", async (req, res) => {
  ...
  try {
    ...
    //Arya College DM Workshop
    //  doc.image(path.join(__dirname, "AryaCollege.png"), 0, 0, {
    //   width: 2000,
    //   height: 1414,
    // });
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
     ...
     //LCET AI/ML
    //  doc.image(path.join(__dirname, "LCET_AI.png"), 0, 0, {
    //   width: 2000,
    //   height: 1414,
    // });
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
    ...
    // DAVIET Shell
    //  doc.image(path.join(__dirname, "DAVIET_Shell.png"), 0, 0, {
    //   width: 2000,
    //   height: 1414,
    // });
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
     ...
     // Lamrin Shell
    //  doc.image(path.join(__dirname, "Larima.png"), 0, 0, {
    //   width: 2000,
    //   height: 1414,
    // });
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
    ...
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
     ...
     //LGC Machine Learning
    //  doc.image(path.join(__dirname, "GCET_Shell.png"), 0, 0, {
    //   width: 2000,
    //   height: 1414,
    // });
    // doc.fontSize(75).text(name, 0, 720, { align: "center" });
